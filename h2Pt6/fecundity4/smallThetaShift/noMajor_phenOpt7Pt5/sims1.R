...
qtlInformation <- NULL
for(j in 1:reps){
  logQuantIndiv_varP0(N0=N_0,K=carryCap,t=80,lambda=1.5,f=4,sexType="herm",nLoci=loci,phen_0=100,phen_opt=107.5,
...
write.table(qtlInformation,file=paste("qtlInfo_N0_",N_0,"_K_",carryCap,"_propMaj_",propMaj,sep=""),quote=FALSE,row.names=FALSE)
