...
###### major loci first
qtlInfo <- read.table("qtlInfo_N0_500_K_1000_propMaj_0.5",row.names=NULL)[,2:4]
rowStarts <- seq(1,nrow(qtlInfo),100)
rowEnds <- seq(100,nrow(qtlInfo),100)
allFreqs <- read.table("allFreqs_N0_500_K_1000_propMaj_0.5",header=TRUE)
...
write.table(potMatMajor,file="evolutionarLimits_N0_500_K_1000_propMaj_0.5",quote=FALSE,row.names=FALSE)
